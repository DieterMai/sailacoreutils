...
public class ConfigCases {
	...
	private static ConfigCase getEConfig() {
		return new ConfigCase("e", "-e", ".e()");
	}

	private static ConfigCase getTConfig() {
		return new ConfigCase("t", "-t", ".t()");
	}

	private static ConfigCase getUConfig() {
		return new ConfigCase("u", "-u", ".u()");
	}

	private static ConfigCase getNumbersAndNumbersNoneblankConfig() {
		return new ConfigCase("NumbersAndNumbersNoneblank", "--number --number-nonblank", ".number().numberNonblank()");
	}

	private static ConfigCase getNumbersAndSqueezeBlankConfig() {
		return new ConfigCase("NumbersAndSqueezeBlank", "--number --squeeze-blank", ".number().numberNonblank()");
	}

	private static ConfigCase getNumbersNoneblankAndSqueezeBlankConfig() {
		return new ConfigCase("NumbersNoneblankAndSqueezeBlank", " --number-nonblank --squeeze-blank",
				".numberNonblank().numberNonblank()");
	}

	private static ConfigCase getNumbersNoneblankAndShowTabsConfig() {
		return new ConfigCase("numbersNoneblankAndShowTabs", "--show-tabs", ".showTabs()");
	}

	private static ConfigCase getNumbersNoneblankAndShowNonprintingConfig() {
		return new ConfigCase("numbersNoneblankAndshowNonprinting", "--number-nonblank --show-nonprinting",
				".numberNonblank().showNonprinting()");
	}

	private static ConfigCase getNumbersNoneblankAndShowEndsConfig() {
		return new ConfigCase("numbersNoneblankAndShowEnds", "--number-nonblank --show-ends",
				".numberNonblank().showEnds()");
	}

	private static ConfigCase getSqueezeBlankAndShowTabsConfig() {
		return new ConfigCase("squeezeBlankAndShowTabs", "--squeeze-blank --show-tabs", ".squeezeBlank().showTabs()");
	}

	private static ConfigCase getSqueezeBlankAndShowNonprintingConfig() {
		return new ConfigCase("squeezeBlankAndShowNonprinting", "--squeeze-blank --show-nonprinting",
				".squeezeBlank().showNonprinting()");
	}

	private static ConfigCase getSqueezeBlankAndShowEndsConfig() {
		return new ConfigCase("squeezeBlankAndShowEnds", "--squeeze-blank --show-ends", ".squeezeBlank().showEnds()");
	}
}
