...
class TextWithMultipleSegmentsOfBlankLinesCatTest {
    ...
    void testnumberNoneblankConfig() {
        ...
        expectedLines.add("     8					");
        expectedLines.add("     9					");
        expectedLines.add("    10					");
        expectedLines.add("    11	This line is not empty again");
        String expectedOutput = String.join("\n", expectedLines);
        CatResult expected = CatResult.of(expectedOutput);
    ...
    void testnumberConfig() {
        ...
        expectedLines.add("     9	    ");
        expectedLines.add("    10	    ");
        expectedLines.add("    11					");
        expectedLines.add("    12					");
        expectedLines.add("    13					");
        expectedLines.add("    14					");
        expectedLines.add("    15	This line is not empty again");
        String expectedOutput = String.join("\n", expectedLines);
        CatResult expected = CatResult.of(expectedOutput);
